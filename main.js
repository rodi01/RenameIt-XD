...
class HistoryDropdown extends React.Component {
  ...
  toggleDropdown(event) {
    ...
    this.menuRef.current.popupAt(rect.right - this.longTextRef.current.clientWidth + 8, rect.bottom + 5);
  }
  ...
  render() {
    ...
    if (this.props.menuData.length > 0) {
      menuItems = this.props.menuData.map((d, idx) => React.createElement("menuitem", {
      ...
      fakeMenu = this.props.menuData.map((d, idx) => React.createElement(
        "div",
        {
    ...
    return React.createElement(
      "div",
      { id: this.props.dropdownId, className: `dropdown ${this.state.isOpened}` },
      React.createElement(
        "div",
        { className: "historyIcon", onClick: this.toggleDropdown },
        React.createElement("img", {
          srcSet: "./assets/historyIcon.png, ./assets/historyIcon@2x.png 2x",
          src: "./assets/historyIcon.png"
        })
      ),
      React.createElement(
        "menu",
        { className: "menuItems", ref: this.menuRef, onClose: this.menuClose },
        menuItems
      ),
      React.createElement(
        "div",
...
class RenameLayers extends React.Component {
  ...
  render() {
    ...
    return React.createElement(
      "form",
      { method: "dialog", style: { width: 330, height: 350 } },
      React.createElement(
        "h1",
        null,
