...
/* harmony import */ var _lib_FindReplace_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./lib/FindReplace.js */ "./src/lib/FindReplace.js");
/* harmony import */ var _Preview_jsx__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Preview.jsx */ "./src/Preview.jsx");
/* harmony import */ var _Preview_jsx__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_Preview_jsx__WEBPACK_IMPORTED_MODULE_2__);
...
class FindReplaceLayers extends react__WEBPACK_IMPORTED_MODULE_0___default.a.Component {
  constructor(props) {
    super(props);
    this.state = {
      findValue: "",
  ...
  doRename(item) {
    ...
    return Object(_lib_FindReplace_js__WEBPACK_IMPORTED_MODULE_1__["matchString"])(opts) ? Object(_lib_FindReplace_js__WEBPACK_IMPORTED_MODULE_1__["findReplace"])(opts) : false;
  }
  ...
  render() {
    return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(
      "form",
      { className: "findReplace", method: "dialog", style: { width: 320 } },
      ...
      react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_Preview_jsx__WEBPACK_IMPORTED_MODULE_2___default.a, { data: this.state.previewData }),
      react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(
        "footer",
        null,
        react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(
...
/* harmony default export */ __webpack_exports__["default"] = (FindReplaceLayers);
...
class NoSelection extends react__WEBPACK_IMPORTED_MODULE_0___default.a.Component {
  constructor(props) {
    super(props);
...
/* harmony import */ var is_number__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! is-number */ "./node_modules/is-number/index.js");
/* harmony import */ var is_number__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(is_number__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _lib_Rename_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./lib/Rename.js */ "./src/lib/Rename.js");
...
class RenameLayers extends react__WEBPACK_IMPORTED_MODULE_0___default.a.Component {
  constructor(props) {
    super(props);
    this.state = {
      valueAttr: "",
  ...
  reorderSelection() {
    ...
    const sameParent = this.props.selection.items.every(elem => elem.parent.guid === firstParent.guid);
    if (sameParent) {
      const arr = [];
  ...
  doRename(item, index) {
    ...
    return Object(_lib_Rename_js__WEBPACK_IMPORTED_MODULE_3__["rename"])(options);
  }
  ...
  onSequenceInputChange(e) {
    if (e.target.value == "" || is_number__WEBPACK_IMPORTED_MODULE_2___default()(e.target.value)) {
      this.setState({
  ...
  previewUpdate() {
    ...
    this.setState({
      disableButton: !is_blank__WEBPACK_IMPORTED_MODULE_1___default()(this.state.valueAttr) && is_number__WEBPACK_IMPORTED_MODULE_2___default()(this.state.sequence) ? "" : "true"
    });
  }
  ...
  onSubmit(e) {
    if (!is_blank__WEBPACK_IMPORTED_MODULE_1___default()(this.state.valueAttr) && is_number__WEBPACK_IMPORTED_MODULE_2___default()(this.state.sequence) && !this.isSubmiting) {
      this.isSubmiting = true;
      this.reorderedSelection.forEach((item, index) => {
  ...
  render() {
    ...
    const listItems = buttons.map(b => react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(
      "li",
      { key: b.id, className: "keywordBtn" },
      react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(
        "button",
        {
          "uxp-variant": "action",
    ...
    return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(
      ...
      react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(
        "div",
        { className: "inputWrapper sequenceInput" },
        react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(
          "label",
          null,
          "Start from"
        ...
        react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(
          "span",
          { className: `error ${this.state.showError}` },
          "\u2190 Number is required"
        )
      ),
      react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(
      ...
      react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_Preview_jsx__WEBPACK_IMPORTED_MODULE_4___default.a, { data: this.state.previewData }),
      react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(
        "footer",
        null,
        react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(
...
/* harmony default export */ __webpack_exports__["default"] = (RenameLayers);
...
/* harmony import */ var change_case__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! change-case */ "./node_modules/change-case/change-case.js");
...
/* harmony import */ var titlecase__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! titlecase */ "./node_modules/titlecase/to-title-case.js");
/* harmony import */ var titlecase__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(titlecase__WEBPACK_IMPORTED_MODULE_1__);
/*
 * @Author: Rodrigo Soares 
...
function currentLayer(newLayerName, layerName) {
  // UpperCase
  let name = newLayerName.replace(/%\*u%/gi, change_case__WEBPACK_IMPORTED_MODULE_0___default.a.upperCase(layerName));

  // LowerCase
  name = name.replace(/%\*l%/gi, change_case__WEBPACK_IMPORTED_MODULE_0___default.a.lowerCase(layerName));

  // Title Case
  name = name.replace(/%\*t%/gi, titlecase__WEBPACK_IMPORTED_MODULE_1___default()(layerName));
  // name = name.replace(/%\*t%/gi, changeCase.titleCase(layerName))

  // UpperCase First
  name = name.replace(/%\*uf%/gi, change_case__WEBPACK_IMPORTED_MODULE_0___default.a.upperCaseFirst(layerName));

  // Camel Case
  name = name.replace(/%\*c%/gi, change_case__WEBPACK_IMPORTED_MODULE_0___default.a.camelCase(layerName));
...
function showDialog(selection, to, documentRoot) {
  ...
  if (dialog == null) {
    ...
    switch (where) {
      case whereTo.RENAME:
        ReactDOM.render(React.createElement(RenameLayers, { dialog: dialog, selection: selection, documentRoot: documentRoot }), dialog);
        break;
